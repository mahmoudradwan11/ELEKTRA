...
class LaptopsProducts extends StatelessWidget {
  const LaptopsProducts({Key? key}) : super(key: key);
                      ...
                      return Container(
                        ...
                        child: GridView.count(
                          ...
                          children: List.generate(
                              cubit.homeLaptops!.allProduct!.length,
                                  (index) =>
                                  buildProductItem(cubit.homeLaptops!.allProduct![index],context)),
                        ),
                      );
                      },
                    );
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                            cubit.homeLaptops!.newProduct!.length,
                                (index) =>
                                buildProductItem(cubit.homeLaptops!.newProduct![index],context)),
                      ),
                    );
                  },
                );
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(
                            cubit.homeLaptops!.usedProduct!.length,
                                (index) =>
                                buildProductItem(cubit.homeLaptops!.usedProduct![index],context)),
                      ),
                    );
                  },
                );
