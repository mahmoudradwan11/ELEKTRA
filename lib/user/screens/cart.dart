...
import 'package:lp/core/user_controller/cart_cubit/cart_cubit.dart';
...
import 'package:lp/user/screens/checkout.dart';
import 'package:lp/user/widgets/build_cart_item.dart';
                          ...
                          children: [
                            ...
                            InkWell(
                                onTap: () {
                                   ...
                                   //navigateTo(context,(price:cubit.totalCart!.totalPrice.round()+10,));
                                },
                                child: const Text(
                                  'Checkout',
                                  style: TextStyle(
