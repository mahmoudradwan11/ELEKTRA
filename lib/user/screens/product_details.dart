...
import 'package:lp/core/mangers/strings.dart';
import 'package:lp/core/mangers/values.dart';
import 'package:lp/core/user_controller/favorite_cubit/favorite_cubit.dart';
import 'package:lp/core/user_controller/favorite_cubit/favorite_states.dart';
...
import 'package:lp/user/widgets/product_details/build_review_item.dart';
import 'package:lp/user/widgets/button.dart';
import 'package:lp/user/widgets/product_details/build_acc_specification.dart';
import 'package:lp/user/widgets/product_details/build_laptop_specification.dart';
import 'package:lp/user/widgets/product_details/build_phone_specification.dart';
import 'package:lp/user/widgets/product_details/build_tv_specifaction.dart';
import 'package:lp/user/widgets/product_details/build_watches_specification.dart';
import 'package:lp/user/widgets/product_details/product_details_view.dart';
...
class ProductDetails extends StatefulWidget {
  ...
  ProductDetails({Key? key, this.model, this.companyImage}) : super(key: key);
                  ...
                  children: [
                    ...
                    BlocConsumer<FavoriteCubit, FavoriteStates>(
                        ...
                        builder: (context, state) {
                          ...
                          return InkWell(
                            onTap: () {
                              widget.model.inFavorite
                                  ? cubit.deleteFavorite(widget.model.sId, context)
                                  : cubit.addToMyFavorite(widget.model.sId, context);
                            },
                            child: Container(
                                decoration: BoxDecoration(
